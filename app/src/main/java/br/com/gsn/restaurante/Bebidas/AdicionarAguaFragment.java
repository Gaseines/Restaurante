...
public class AdicionarAguaFragment extends Fragment {

    private TextView nome;
    private TextView preco;

    public AdicionarAguaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.carrinho_fragment_adicionar_agua, container, false);
