...
public class AdicionarSushiVinteumFragment extends Fragment {

    private TextView nome;
    private TextView preco;

    public AdicionarSushiVinteumFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.carrinho_fragment_adicionar_sushi_vinteum, container, false);
