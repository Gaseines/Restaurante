...
public class AdicionarTradicionalFragment extends Fragment {
    ...
    public AdicionarTradicionalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v =  inflater.inflate(R.layout.carrinho_fragment_adicionar_tradicional, container, false);
