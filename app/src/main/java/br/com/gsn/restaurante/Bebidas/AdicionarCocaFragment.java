...
public class AdicionarCocaFragment extends Fragment {

    private TextView nome;
    private TextView preco;

    public AdicionarCocaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.carrinho_fragment_adicionar_coca, container, false);
