...
public class AdicionarLegumesFragment extends Fragment {
    ...
    public AdicionarLegumesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.carrinho_fragment_adicionar_legumes, container, false);
