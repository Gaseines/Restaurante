...
public class AdicionarBaconFragment extends Fragment {

    private TextView nome;
    private TextView preco;

    public AdicionarBaconFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.carrinho_fragment_adicionar_bacon, container, false);
