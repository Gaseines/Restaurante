package br.com.gsn.restaurante.Bebidas;
...
import br.com.gsn.restaurante.Cardapio.BebidasFragment;
...
public class AdicionarSucoFragment extends Fragment {

    private TextView nome;
    private TextView preco;

    public AdicionarSucoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.carrinho_fragment_adicionar_suco, container, false);
        ...
        btnCancelar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameHorarios, new BebidasFragment()).commit();
            }
        });
